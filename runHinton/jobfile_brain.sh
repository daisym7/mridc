...
python -m mridc.launch --config-path /home/dmvandenberg/PycharmProjects/mridc/projects/reconstruction/model_zoo/conf/ --config-name base_cirim_train_brain.yaml
